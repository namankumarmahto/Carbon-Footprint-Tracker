...
public class Choise_personal_home extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        personalButton.setOnClickListener(v -> startActivity(new Intent(this, Registation.class)));
        industryButton.setOnClickListener(v -> startActivity(new Intent(this, Registation_Industry.class)));
    }
}
